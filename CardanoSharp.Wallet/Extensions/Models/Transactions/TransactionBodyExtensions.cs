...
{
    public static CBORObject GetCBOR(this TransactionBody transactionBody, AuxiliaryData? auxiliaryData, bool withSetTag = true)
    {
        ...
        {
            cborInputs = withSetTag ? CBORObject.NewArray().WithTag(258) : CBORObject.NewArray();
        ...
        {
            CBORObject cborTransactionCertificates = withSetTag ? CBORObject.NewArray().WithTag(258) : CBORObject.NewArray();
        ...
        {
            cborCollateralInputs = withSetTag ? CBORObject.NewArray().WithTag(258) : CBORObject.NewArray();
        ...
        {
            cborRequiredSigners = withSetTag ? CBORObject.NewArray().WithTag(258) : CBORObject.NewArray();
        ...
        {
            cborReferenceInputs = withSetTag ? CBORObject.NewArray().WithTag(258) : CBORObject.NewArray();
    ...
    public static byte[] Serialize(this TransactionBody transactionBody, AuxiliaryData auxiliaryData, bool withSetTag = true)
    {
        return transactionBody.GetCBOR(auxiliaryData, withSetTag).EncodeToBytes();
    }
