...
public static partial class ScriptReferenceExtensions
{
    ...
    public static ScriptReference GetScriptReference(this CBORObject scriptReferenceCborWithTag)
    {
        ...
        var decodedScriptReferenceCbor = CBORObject.DecodeFromBytes(((string)scriptReferenceCbor.DecodeValueByCborType()).HexToByteArray());
        ...
        if (scriptKey == 0)
        {
            ...
            NativeScript nativeScript = (NativeScript)decodedScriptReferenceCbor[1].DecodeValueByCborType();
        ...
        {
            byte[] plutusV2ScriptBytes = ((string)decodedScriptReferenceCbor[1].DecodeValueByCborType()).HexToByteArray();
