...
public class NativeScriptBuilder : ABuilder<NativeScript>, INativeScriptBuilder
{
    ...
    {
        _model.ScriptPubKey = new ScriptPubKey() { KeyHash = keyHash };
        return this;
    }
    ...
    {
        _model.InvalidAfter = new ScriptInvalidAfter() { After = after };
        return this;
    }

    public INativeScriptBuilder SetInvalidBefore(uint before)
    {
        _model.InvalidBefore = new ScriptInvalidBefore() { Before = before };
        return this;
    }
}
